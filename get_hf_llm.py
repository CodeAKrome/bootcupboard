    ...
    for directory in directories_to_check:
        ...
        if confirm_action(""):
            for model_details in combined_models:
                if model_details["filename"] == selected_model:
                    ...
                    if not enough_disk_space(
                        ...
                        print(
                            f"You do not have enough disk space available to download this model."
                        )
                        return None
            ...
            split_files = [
                ...
                if selected_model in model["filename"]
            ]
    ...
    try:
        ...
        if confirm_action(message):
            ...
            def install_llama(backend):
                ...
                try:
                    safe_command.run(subprocess.run, [sys.executable, "-m", "pip", "install", "llama-cpp-python"],

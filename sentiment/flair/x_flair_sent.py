...
def FlairSentiment(text: str) -> list:
...
# --- MAIN ---
# TEXT = """President Reagan is a foolish man.
# I hate him. I love the color of the White House, but Reagan is stupid.
# """
#out = FlairSentiment(TEXT)
out = FlairSentiment(sys.stdin.read())
for rec in out:
